...
import {addPizzaCart} from "../store/cartReducer";

const PizzaItem = ({id, imageUrl, name, types, sizes, price, addedCount}) => {
            ...
            <div className="pizza-block__selector">
                <ul>
                    {availableTypes.map((type, index) => (<li
                        ...
                        onClick={() => onSelectTypes(index)}>{type}</li>))}
                </ul>
                <ul>
                    {availableSizes.map((size, index) => <li
                        onClick={() => onSelectSeize(index)}
                        className={classNames({
